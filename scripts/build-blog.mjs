...
for (const post of posts) {
  ...
  await save(`public/blog/${post.slug}/index.html`, shell({ title: post.title, description: post.description, type: 'blog-article', body, math: true }));
...
await save('public/blog/index.html', shell({ title: '文字与记录', description: 'yangjm 的学习笔记与思考。', type: 'blog-index', body: indexBody }));
